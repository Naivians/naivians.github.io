     ...
     <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         <div class="grid md:grid-cols-2 gap-12 items-center">
             ...
             <div class="relative hidden md:block animate-float">
                 <div
                     class="absolute -top-6 -left-6 w-32 h-32 bg-indigo-100 rounded-full animate-pulse"></div>
                 <div
                     class="absolute -bottom-6 -right-6 w-32 h-32 bg-purple-100 rounded-full animate-pulse"></div>
                 <img
